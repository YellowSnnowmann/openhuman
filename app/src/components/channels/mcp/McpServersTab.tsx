          ...
          <div className="min-w-0">
            <span className="flex items-center gap-1.5">
              ...
              {server.auth_kind === 'api_key' && (
                <span
                  title={t('mcp.tab.auth.apiKeyHint')}
                  className="inline-flex items-center gap-0.5 rounded-full bg-amber-100 px-1.5 py-0.5 text-[10px] font-medium text-amber-700 dark:bg-amber-500/15 dark:text-amber-300">
                  🔑 {t('mcp.tab.auth.apiKey')}
                </span>
              )}
            </span>
        ...
        <table className="w-full min-w-[640px] text-sm">
          <thead>
            <tr className="border-b border-stone-100 dark:border-neutral-800 bg-stone-50 dark:bg-neutral-900">
              ...
              <th className="text-left px-4 py-2.5 text-xs font-medium text-stone-500 dark:text-neutral-400 hidden sm:table-cell w-28">
