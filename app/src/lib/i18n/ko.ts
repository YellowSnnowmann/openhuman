...
const messages: TranslationMap = {
  ...
  'skills.meetingBots.ownerNameLabel': '통화에서 내 이름',
  'skills.meetingBots.ownerNamePlaceholder': '통화에 표시되는 이름 (예: 민준)',
  'skills.meetingBots.ownerNameHint': '개인정보 잠금 — 이 이름이 말할 때만 OpenHuman이 응답합니다.',
