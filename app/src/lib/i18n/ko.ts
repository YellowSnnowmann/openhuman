...
const messages: TranslationMap = {
  ...
  'skills.meetingBots.respondToParticipant': '참가자에게 응답',
  'skills.meetingBots.respondToParticipantHint': '예: 김철수',
  'skills.meetingBots.respondToParticipantDesc': '모든 사람에게 응답하려면 비워 두세요.',
