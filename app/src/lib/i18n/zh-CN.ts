...
const messages: TranslationMap = {
  ...
  'skills.meetingBots.ownerNameLabel': '您在通话中的名字',
  'skills.meetingBots.ownerNamePlaceholder': '与通话中显示的相同（例如 张三）',
  'skills.meetingBots.ownerNameHint': '隐私锁定 — 仅当此名字发言时，OpenHuman 才会响应。',
