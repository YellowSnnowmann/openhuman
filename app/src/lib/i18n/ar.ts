...
const messages: TranslationMap = {
  ...
  'skills.meetingBots.ownerNameLabel': 'اسمك في المكالمة',
  'skills.meetingBots.ownerNamePlaceholder': 'كما يظهر في المكالمة (مثال: أحمد)',
  'skills.meetingBots.ownerNameHint': 'قفل الخصوصية — يستجيب OpenHuman فقط عند نطق هذا الاسم.',
