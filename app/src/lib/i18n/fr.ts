...
const messages: TranslationMap = {
  ...
  'channels.connectHelp.title': 'Comment connecter',
  ...
  'channels.connectHelp.slackNote':
    'Vous cherchez Slack ? Slack se connecte comme une app dans l’onglet OAuth, pas comme un canal de messagerie ici.',
