...
const messages: TranslationMap = {
  ...
  'skills.meetingBots.respondToParticipant': 'Отвечать участнику',
  'skills.meetingBots.respondToParticipantHint': 'напр. Иван',
  'skills.meetingBots.respondToParticipantDesc': 'Оставьте пустым, чтобы отвечать всем.',
